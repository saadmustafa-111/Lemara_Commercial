      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto relative z-10">
        <div>
          <div className="mb-5 sm:mb-8">
            <h1 
              className={`mb-2 font-semibold text-gray-800 text-title-sm dark:text-white/90 sm:text-title-md relative ${typingComplete ? 'text-animation-complete' : ''}`}
            >
              <span className="inline-block">{titleText}</span>
              <span 
                className="inline-block w-1 h-8 bg-purple-500 dark:bg-purple-400 ml-1 absolute"
                style={{ 
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full py-3 font-medium text-white transition-all rounded-lg bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 focus:ring-2 focus:ring-purple-400 disabled:opacity-70 flex justify-center items-center"
