    ...
    <div className="relative px-4 py-6 bg-white dark:bg-gray-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 rounded-full">
        {dashboardData.properties.map(property => (
          <div key={property.id} className="flex flex-col rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm dark:bg-gray-800">
            ...
            <div className="p-4 flex-grow flex flex-col">
              <h3 className="font-bold text-lg mb-1 text-gray-800 dark:text-white">{property.title}</h3>
              {property.location && (
                <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">{property.location}</p>
              )}
              {!property.location && <div className="mb-3"></div>}
              
              <div className="mb-3">
                <p className="font-medium text-gray-800 dark:text-white">Income</p>
              ...
              <div className="mb-auto">
                <p className="font-medium text-gray-800 dark:text-white">Details</p>
                <div className="grid grid-cols-2 gap-1 text-sm">
              ...
              <div className="mt-4 flex justify-between items-center bg-[#00a0d1] dark:bg-[#007ab3] text-white p-3 rounded-md">
