    ...
    <>
      <div className='flex flex-col gap-4 w-full p-4'>
        <div className='flex items-center gap-3'>
          ...
          <h1 className='text-[32px] text-[#06AED7] font-bold'>
            My Contacts
          </h1>
        </div>

        <div className="flex items-center justify-between w-full">
          <div className="flex items-center bg-white border border-gray-300 rounded-full px-8 py-3 w-full max-w-md">
            <Search className="text-[#06AED7] mr-2 w-5 h-5" />
            <input
              type="text"
          ...
          <button className="ml-4 text-black bg-white px-8 py-3 border border-black rounded-full transition-all duration-300 hover:bg-[#06AED7] hover:text-white hover:border-[#06AED7]">
            Actions
          </button>
        </div>
        ...
        <div className='flex items-center gap-3.5'>
          ...
          <button onClick={() => router.push('/dashboard/agent/addcontact')} className="ml-4 text-black bg-white px-8 py-3 border border-black rounded-full transition-all duration-300 hover:bg-[#06AED7] hover:text-white hover:border-[#06AED7]">
            Create New Contact
          </button>        
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th scope="col" className="px-6 py-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Name</th>
                  <th scope="col" className="px-6 py-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Title</th>
                  <th scope="col" className="px-6 py-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Phone</th>
                  <th scope="col" className="px-6 py-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Email</th>
                  <th scope="col" className="px-6 py-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Company</th>
                  <th scope="col" className="px-6 py-4 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Actions</th>
                </tr>
              </thead>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-3">
                        <button 
                          ...
                          className="text-[#06AED7] hover:text-[#048eb1] transition-colors"
                        >
                          <Pencil size={18} />
                        </button>
                        <button 
